...
var ProxySigner = function(proxy_address, signer) {
  this.proxy_address = proxy_address;
  this.signer = signer;
}

ProxySigner.prototype.hasAddress = function(address, callback) {
  callback(null, this.proxy_address === address );
}

ProxySigner.prototype.getAddresses = function(callback) {
  callback(null, [this.proxy_address]);
}
