...
function _asymEncryptRaw (keystore, pwDerivedKey, msgUint8Array, myAddress, theirPubKey) {
  ...
  if (keystore.encPrivKeys[myAddress] === undefined) {
    throw new Error('encryption._asymEncryptRaw: address not found in KeyStore');
  }
...
function _asymDecryptRaw (keystore, pwDerivedKey, encMsg, theirPubKey, myAddress) {
  ...
  if (keystore.encPrivKeys[myAddress] === undefined) {
    throw new Error('encryption._asymDecryptRaw: address not found in KeyStore');
  }
